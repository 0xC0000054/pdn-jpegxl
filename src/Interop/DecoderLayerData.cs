    ...
    internal sealed unsafe class DecoderLayerData : Disposable
    {
                                            ...
                                            byte* pixels)
        {
            ...
            return (colorSpace, channelRepresentation, hasTransparency) switch
            {
                ...
                (JpegXLColorSpace.Gray, JpegXLImageChannelRepresentation.Float16, true) => CopyGrayAlphaToRgbaBitmap<ColorGenericXY32Half, ColorGray16Half, ColorGray16Half /* ColorAlpha16Half not public in 9542 */, ColorRgba64Half>(imagingFactory, width, height, pixels),
                ...
                (JpegXLColorSpace.Gray, JpegXLImageChannelRepresentation.Float32, true) => CopyGrayAlphaToRgbaBitmap<ColorGenericXY64Float, ColorGray32Float, ColorGray32Float /* ColorAlpha32Float not public in 9542 */, ColorRgba128Float>(imagingFactory, width, height, pixels),
